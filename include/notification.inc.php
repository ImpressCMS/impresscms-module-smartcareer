...
function smartcareer_notify_iteminfo($category, $item_id)
{
    ...
    if ($category == 'item') {
        ...
        $sql = 'SELECT question FROM ' . $xoopsDB->prefix('smartcareer_partner') . ' WHERE id = ' . $item_id;
